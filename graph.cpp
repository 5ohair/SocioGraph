...
void SocialNetwork::friendsUser(string name) {
    //flg false, will update later
    bool found = false;

    // Raylib Window Setup
    const int screenWidth = 800;
    const int screenHeight = 600;
    InitWindow(screenWidth, screenHeight, "Friends List - SocioGraph");
    SetTargetFPS(60);
    ...
    while (!WindowShouldClose()) {
        ...
        // Draw each notifying message from the friends list
        int yOffset = 100;
...
void SocialNetwork::userLogin() {
    const int screenWidth = 800;
    const int screenHeight = 600;
    InitWindow(screenWidth, screenHeight, "Login - SocioGraph");
...
//store text enterrd bu user
    string usernameInput = "";
    string passwordInput = "";
    //which input bx is acitve
...
void SocialNetwork::userSignUp() {
    ...
    InitWindow(screenWidth, screenHeight, "Sign Up - SocioGraph");
    SetTargetFPS(60);
...
void SocialNetwork::findShortestPath(const string &startInput) {
    ...
    const int screenHeight = 600;
    InitWindow(screenWidth, screenHeight, "Ties of Connections - SocioGraph");
